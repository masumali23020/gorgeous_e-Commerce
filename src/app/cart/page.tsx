                        ...
                        <div>
                            {cartItems.map(item => (
                                ...
                                <div key={item.id} className="flex items-center justify-between  ">
                                    ...
                                    {/* delete button  */}
                                    <button className="w-8 h-8 rounded-full bg-red-100 hover:bg-red-200 transition-all duration-300 text-red-400 flex justify-center items-center cursor-pointer">
